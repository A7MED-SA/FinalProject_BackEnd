    ...
    IdentityUserToken<Guid>>
{
    ...
    public DbSet<InstructorRequestDocument> InstructorRequestDocuments { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        // Instructor Request Relationships
        modelBuilder.Entity<InstructorRequest>()
            .HasOne(tr => tr.User)
            .WithMany(u => u.SubmittedInstructorRequests)
            .HasForeignKey(tr => tr.UserId)
            .OnDelete(DeleteBehavior.Restrict);

        modelBuilder.Entity<InstructorRequest>()
            .HasOne(tr => tr.ProcessedByUser)
            .WithMany(u => u.ProcessedInstructorRequests)
        ...
        modelBuilder.Entity<Category>()
            ...
            .WithMany()
            .HasForeignKey(c => c.CategoryImageFileId)
        ...
        modelBuilder.Entity<Certificate>()
            ...
            .WithMany()
            .HasForeignKey(c => c.CertificateFileId)
            .OnDelete(DeleteBehavior.SetNull);
        ...
        modelBuilder.Entity<VideoComment>().HasQueryFilter(e => e.DeletedAt == null);
        modelBuilder.Entity<UploadedFile>().HasQueryFilter(e => e.DeletedAt == null);
